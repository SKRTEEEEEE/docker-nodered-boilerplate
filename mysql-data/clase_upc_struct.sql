...
--
-- Host: localhost    Database: clase_upc
-- ------------------------------------------------------
...
CREATE TABLE `datos` (
  ...
  CONSTRAINT `datos_ibfk_1` FOREIGN KEY (`idsensor`) REFERENCES `sensor` (`id`)
...
CREATE TABLE `sensor` (
  ...
  `iddatalogger` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `iddatalogger` (`iddatalogger`),
  CONSTRAINT `sensor_ibfk_1` FOREIGN KEY (`iddatalogger`) REFERENCES `datalogger` (`id`)
...
-- Dump completed on 2025-06-04 17:52:55
